...
- una funzione 'newCircle(descr string) Cerchio'
	...
	(nome, coordinate x e y del centro, raggio separati da spazi)
...
e stampa se il cerchio, rispetto a quello precedente, è tangente o no e maggiore o no.
...
func TestComeDaEsempio(t *testing.T) {
	lanciaGenerica(t, prog, "uno 0.5 0 2.5\ndue 0 0 3\ntre 10.2 -8.4 1.5", "{uno 0.5 0 2.5} non tangente, maggiore\n{due 0 0 3} tangente, maggiore\n{tre 10.2 -8.4 1.5} non tangente, minore o uguale\n")
}
